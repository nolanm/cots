...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '2.2.5');
	...
	function cmsmasters_composer_enqueue_scripts($hook) {
		...
		/* Start cmsmasters_social Translations */
			...
			'social_sharing_field_googleplus_button_title' =>	__('Google+ Button', 'cmsmasters-content-composer'),
		...
		/* Start cmsmasters_twitter Translations */
			...
			'twitter_field_username_title' =>					__('Twitter Username', 'cmsmasters-content-composer'),
			'twitter_field_username_descr' =>					__('Enter your Twitter username', 'cmsmasters-content-composer'),
			'twitter_field_tweets_number_title' =>				__('Tweets Number', 'cmsmasters-content-composer'),
			'twitter_field_tweets_number_descr' =>				__("Enter the number of latest tweets you'd like to display", 'cmsmasters-content-composer'),
			'twitter_field_tweets_number_descr_note' =>			__('(5 - if empty)', 'cmsmasters-content-composer'),
			...
			'twitter_field_slider_controls_title' =>			__('Slider Controls', 'cmsmasters-content-composer'),
			'twitter_field_slider_controls_descr' =>			__('If checked, enable tweets slider controls', 'cmsmasters-content-composer'),
			
			'twitter_field_slider_autoplay_descr' =>			__('Animate next tweet automatically', 'cmsmasters-content-composer'),
			
			'twitter_field_slider_speed_descr' =>				__('Time before next slide will appear', 'cmsmasters-content-composer'),
			'twitter_field_slider_speed_descr_note' =>			__('If empty - 3', 'cmsmasters-content-composer'),
