...
function salvation_tribe_events_fonts($custom_css) {
...
/***************** Start Tribe Events Font Styles ******************/
	...
	.cmsmasters_column.one_first .tribe-events-adv-list-widget .tribe-events-list-widget-content-wrap .entry-title a,
	.cmsmasters_column.one_first .tribe-events-list-widget .tribe-events-list-widget-content-wrap .entry-title a {
		font-size:" . ((int) $cmsmasters_option['salvation' . '_h2_font_font_size'] - 6) . "px;
	}
	...
	.cmsmasters_column.one_first .tribe-events-list-widget .tribe-events-list-widget-content-wrap .cmsmasters_widget_event_info a {
		...
		line-height:" . ((int) $cmsmasters_option['salvation' . '_h4_font_line_height'] - 12) . "px;
	}
	...
	.cmsmasters_event_big_month {
		line-height:" . ((int) $cmsmasters_option['salvation' . '_h5_font_line_height'] - 5) . "px;
	}
	...
	.tribe-events-list .cmsmasters_featured_event {	
		font-size:" . ((int) $cmsmasters_option['salvation' . '_h5_font_font_size'] - 4) . "px;
		line-height:" . ((int) $cmsmasters_option['salvation' . '_h5_font_line_height'] - 4) . "px;
	}
	...
	ul.tribe-related-events .tribe-related-event-info .published {
		font-size:" . ((int) $cmsmasters_option['salvation' . '_h6_font_font_size'] - 2) . "px;
		line-height:" . ((int) $cmsmasters_option['salvation' . '_h6_font_line_height'] - 6) . "px;
	}
	/* Finish H6 Font */
	...
	.cmsmasters_event_big_week {
		font-family:" . salvation_get_google_font($cmsmasters_option['salvation' . '_small_font_google_font']) . $cmsmasters_option['salvation' . '_button_font_system_font'] . ";
	...
	.cmsmasters_event_big_week {
		line-height:" . ((int) $cmsmasters_option['salvation' . '_small_font_line_height'] + 3) . "px;
	}
...
add_filter('salvation_theme_fonts_filter', 'salvation_tribe_events_fonts');
