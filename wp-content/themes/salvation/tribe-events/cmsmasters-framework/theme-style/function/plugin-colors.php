...
function salvation_tribe_events_colors($custom_css) {
...
/***************** Start {$title} Tribe Events Color Scheme Rules ******************/
	...
	{$rule}.datepicker table tr td.active.active {
	...
	{$rule}.datepicker table tr td.active:hover, 
	{$rule}.datepicker table tr td.active.disabled, 
	{$rule}.datepicker table tr td.active.disabled:hover {
		background-image: none;
	}
	...
	{$rule}.tribe-events-list .tribe-events-venue-details a:hover,
	...
	{$rule}.cmsmasters_sidebar.sidebar_layout_11 .tribe-events-adv-list-widget .tribe-events-list-widget-content-wrap .tribe-events-venue a:hover,
	...
	{$rule}.tribe-events-read-more:hover,
	{$rule}.datepicker table tr td.active.active:hover, 
	{$rule}.datepicker table tr td.active.disabled:hover, 
	{$rule}.datepicker table tr td.active.disabled:hover:hover, 
	{$rule}.datepicker table tr td.active:active, 
	{$rule}.datepicker table tr td.active:hover:active, 
	{$rule}.datepicker table tr td.active.disabled:active, 
	{$rule}.datepicker table tr td.active.disabled:hover:active,  
	{$rule}.datepicker table tr td.active:hover.active, 
	{$rule}.datepicker table tr td.active.disabled.active, 
	{$rule}.datepicker table tr td.active.disabled:hover.active, 
	{$rule}.datepicker table tr td.active.disabled, 
	{$rule}.datepicker table tr td.active:hover.disabled, 
	{$rule}.datepicker table tr td.active.disabled.disabled, 
	{$rule}.datepicker table tr td.active.disabled:hover.disabled {
	...
	{$rule}.tribe-events-list .tribe-events-venue-details a,
	...
	{$rule}.event_bg,
	{$rule}.tribe-events-read-more,
	{$rule}.cmsmasters_sidebar.sidebar_layout_11 .tribe-events-adv-list-widget .cmsmasters_events_more .tribe-events-read-more,
	{$rule}.cmsmasters_sidebar.sidebar_layout_11 .tribe-events-adv-list-widget .cmsmasters_events_more .tribe-events-read-more:hover,
	{$rule}.cmsmasters_sidebar.sidebar_layout_11 .tribe-events-list-widget .cmsmasters_events_more .tribe-events-read-more,
	{$rule}.cmsmasters_sidebar.sidebar_layout_11 .tribe-events-list-widget .cmsmasters_events_more .tribe-events-read-more:hover,
	{$rule}.tribe-mobile-day .tribe-events-read-more:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.recurringinfo .recurring-info-tooltip:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.tribe-events-grid .tribe-events-day-column-5 .tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-left-color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['salvation' . '_' . $scheme . '_border']) . "
	}	
	
	{$rule}.recurringinfo .recurring-info-tooltip:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['salvation' . '_' . $scheme . '_border']) . "
	}
...
add_filter('salvation_theme_colors_secondary_filter', 'salvation_tribe_events_colors');
