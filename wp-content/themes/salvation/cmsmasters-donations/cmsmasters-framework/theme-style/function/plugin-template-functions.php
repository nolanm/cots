...
function salvation_donations_header_mid_button($cmsmasters_option) {
	if (
		isset($cmsmasters_option['salvation' . '_header_donations_but']) && 
		$cmsmasters_option['salvation' . '_header_donations_but'] && 
		isset($cmsmasters_option['salvation' . '_header_donations_but_text']) && 
		$cmsmasters_option['salvation' . '_header_donations_but_text'] != '' && 
		...
		$cmsmasters_donations_button_link = (isset($cmsmasters_option['salvation' . '_header_donations_but_link']) && $cmsmasters_option['salvation' . '_header_donations_but_link'] != '' ? $cmsmasters_option['salvation' . '_header_donations_but_link'] : get_permalink($cmsmasters_donations_form_page));
			...
			'<div class="header_donation_but_wrap_inner">' . 
				'<div class="header_donation_but">' . 
					'<a href="' . esc_url($cmsmasters_donations_button_link) . '" class="cmsmasters_button">' .  
						'<span>' . esc_html($cmsmasters_option['salvation' . '_header_donations_but_text']) . '</span>' . 
					'</a>' . 
				'</div>' . 
			'</div>' . 
		'</div>';
...
add_action('cmsmasters_after_logo', 'salvation_donations_header_mid_button', 1);



/********** Template Functions for Campaign **********/
/* Get Campaigns Heading Function */
function salvation_donations_campaign_heading($cmsmasters_id, $tag = 'h1', $link = true, $show = true) { 
...
function salvation_donations_campaign_date($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		$out = '<span class="cmsmasters_campaign_date">' . 
			esc_html__('On', 'salvation') . ' ' . 
...
function salvation_donations_campaign_author($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		$out = '<span class="cmsmasters_campaign_user_name">' . 
			esc_html__('By', 'salvation') . ' ' . 
			'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Posts by', 'salvation') . ' ' . get_the_author_meta('display_name') . '" class="vcard author"><span class="fn" rel="author">' . get_the_author_meta('display_name') . '</span></a>' . 
		'</span>';
	} elseif ($template_type == 'post') {
		$cmsmasters_option = salvation_get_global_options();
		...
		if ($cmsmasters_option['salvation' . '_donations_campaign_author']) {
			$out .= '<span class="cmsmasters_campaign_user_name">' . 
				esc_html__('by', 'salvation') . ' ' . 
				'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Posts by', 'salvation') . ' ' . get_the_author_meta('display_name') . '" class="vcard author"><span class="fn" rel="author">' . get_the_author_meta('display_name') . '</span></a>' . 
			'</span>';
...
function salvation_donations_campaign_category($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['salvation' . '_donations_campaign_cat']) {
				$out .= '<span class="cmsmasters_campaign_category">' . 
					get_the_term_list($cmsmasters_id, $taxonomy, esc_html__('in', 'salvation') . ' ', ', ', '') . 
				'</span>';
			}
		}
...
function salvation_donations_campaign_tags($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['salvation' . '_donations_campaign_tag']) {
				$out .= '<span class="cmsmasters_campaign_tags">' . 
					get_the_term_list($cmsmasters_id, $taxonomy, esc_html__('tags', 'salvation') . ' ', ', ', '') . 
				'</span>';
			}
		}
...
function salvation_donations_campaign_exc_cont($content = '', $word_count = 55, $show = true) {
	if ($content != '') {
...
function salvation_donations_campaign_like($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		...
		if ($cmsmasters_option['salvation' . '_donations_campaign_like']) {
			$out = cmsmasters_like(false);
		}
	}
...
function salvation_donations_campaign_comments($template_type = 'page', $show = true) {
	if (comments_open()) {
		if ($template_type == 'page') {
			$out = '<a class="cmsmasters_comments cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'salvation') . ' ' . get_the_title() . '">' . 
			...
			if ($cmsmasters_option['salvation' . '_donations_campaign_comment']) {
				$out = '<a class="cmsmasters_post_comments cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'salvation') . ' ' . get_the_title() . '">' . 
					'<span>' . get_comments_number() . '</span>' . 
				'</a>';
			}
		}
...
function salvation_donations_campaign_rest_amount($cmsmasters_id, $show = true) {
	...
	$out = '<span class="cmsmasters_campaign_rest_amount">' . 
		sprintf(esc_attr__('%s To Go', 'salvation'), cmsmasters_donations_currency($togo_number)) . 
	'</span>';
...
function salvation_donations_campaign_target($cmsmasters_id, $show = true) {
	...
	$out = '<div class="cmsmasters_campaign_target">' . 
		'<div class="cmsmasters_campaign_target_inner">' . 
			...
			'<h5 class="cmsmasters_campaign_target_title">' . esc_html__('Campaign Target', 'salvation') . '</h5>' . 
		'</div>' . 
	'</div>';
...
function salvation_donations_campaign_donations_count($cmsmasters_id, $show = true) {
	...
	$out = '<div class="cmsmasters_campaign_donations_count">' . 
		'<div class="cmsmasters_campaign_donations_count_inner">' . 
			...
			'<h5 class="cmsmasters_campaign_donations_count_title">' . ($funds_number == 1 ? esc_html__('Donation', 'salvation') : esc_html__('Donations', 'salvation')). '</h5>' . 
		'</div>' . 
	'</div>';
...
function salvation_donations_campaign_donated($cmsmasters_id, $template_type = 'page', $layout_type = 'horizontal', $togo = true, $show = true, $color = '') {
	$target = get_the_campaign_target($cmsmasters_id);
	...
	if ($template_type == 'page') {
		if ($layout_type == 'horizontal') {
				...
				'<div class="cmsmasters_stats stats_mode_bars stats_type_horizontal">' . 
					'<div class="cmsmasters_stat_wrap">' . 
						'<div class="cmsmasters_stat_title_wrap">' . 
							...
							'</span>' . 
							'<span class="cmsmasters_stat_title">' . esc_html__('Donated', 'salvation') . '</span>' . 
						'</div>' . 
						...
						'</div>' . 
						'<span class="cmsmasters_stat_subtitle">' . sprintf(esc_attr__('%s to go', 'salvation'), cmsmasters_donations_currency($togo_number)) . '</span>' . 
					'</div>' . 
				'</div>' . 
			'</div>';
			...
			$out = '<div class="cmsmasters_campaign_donated_percent">' . 
				do_shortcode('[cmsmasters_stats mode="circles" count="1"][cmsmasters_stat progress="' . esc_attr($progress) . '"' . (($color != '') ? ' color="' . $color . '"' : '') . ']' . esc_html__('Donated', 'salvation') . '[/cmsmasters_stat][/cmsmasters_stats]') . 
			'</div>';
		}
	} elseif ($template_type == 'post') {
		$shortcode_styles .= "\n" . 
...
function salvation_donations_campaign_donated_open_style() {
	...
	if (get_post_type($campaign_id) == 'campaign') {
		...
		if ($shortcode_styles != '') {
			wp_add_inline_style('salvation-style', $shortcode_styles);
		}
	}
}

add_action('wp_enqueue_scripts', 'salvation_donations_campaign_donated_open_style');


/* Get Campaign Donate Button Function */
function salvation_donations_campaign_donate_button($cmsmasters_id, $show = true) {
	$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
	...
	if ($cmsmasters_campaign_read_more == '') {
		$cmsmasters_campaign_read_more = esc_html__('Donate Now', 'salvation');
	}
...
function salvation_donations_related($tag = 'h3', $title = '', $no_title = '', $box_type = false, $tgsarray = null, $items_number = 5, $pause_time = 5, $type = 'post', $taxonomy = null) {
	if ( 
		...
		echo "<aside class=\"cmsmasters_single_slider cmsmasters_single_slider_campaign\">";
			echo "<" . esc_html($tag) . " class=\"cmsmasters_single_slider_title\">" . 
				($title != '' ? esc_html($title) : esc_html__('More items', 'salvation')) . 
			"</" . esc_html($tag) . ">";
			...
			if ($r_query->have_posts()) {
						...
						while ($r_query->have_posts()) : $r_query->the_post();
							echo "<div class=\"cmsmasters_owl_slider_item cmsmasters_single_slider_item\">
								<div class=\"cmsmasters_single_slider_item_outer\">";
									...
									salvation_thumb(get_the_ID(), 'cmsmasters-blog-masonry-thumb', true, false, true, false, true, true, false, false, false, 'cmsmasters_theme_icon_image');
									...
									echo "<div class=\"cmsmasters_single_slider_item_inner\">
										...
										salvation_donations_campaign_donated(get_the_ID(), 'page', 'horizontal');
				...
				echo "<h5 class=\"cmsmasters_single_slider_no_items\">" . 
					($no_title != '' ? esc_html($no_title) : esc_html__('No items found', 'salvation')) . 
				"</h5>";
			}
...
function salvation_donations_related_styles() {
	...
	if (get_post_type($single_campaign_id) == 'campaign') {
		...
		$items_number = $cmsmasters_option['salvation' . '_donations_more_campaigns_count'];
...
add_action('wp_enqueue_scripts', 'salvation_donations_related_styles');

/********** Template Functions for Donation **********/
/* Get Donations Heading Function */
function salvation_donations_donation_heading($cmsmasters_id, $tag = 'h1', $link = true, $show = true) { 
		...
		'<' . $tag . ' class="cmsmasters_donation_title entry-title">' . 
			($link ? '<a href="' . esc_url(get_permalink()) . '">' : '');
				...
				if (
					...
					$out .= esc_html__('Anonym', 'salvation');
				}
...
function salvation_donations_donation_amount_currency($cmsmasters_id, $template_type = 'page', $show = true) { 
	if (get_the_donation_amount_currency($cmsmasters_id)) {
		if ($template_type == 'page') {
			...
			'</span>' . 
			'<span class="cmsmasters_donation_amount_title">' . esc_html__('Donated', 'salvation') . '</span>';
		} elseif ($template_type == 'post') {
			$out = '<span class="cmsmasters_donation_amount_currency">' . 
				get_the_donation_amount_currency($cmsmasters_id) . 
				((is_recurring_donation($cmsmasters_id)) ? ' ' . get_the_recurrence_period($cmsmasters_id) : ' ' . esc_html__('One-time', 'salvation')) . 
			'</span>';
		}
...
/* Get Donation Amount Currency Function */
function salvation_donations_donation_campaign($cmsmasters_id, $template_type = 'page', $show = true) { 
...
function salvation_donations_donation_details($cmsmasters_id, $show = true) {
	$out = '';
				...
				'<div class="cmsmasters_row_margin">' . 
					'<div class="cmsmasters_column one_half">';
						...
						if (get_the_donator_meta('firstname', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('First Name:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('lastname', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Last Name:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('email', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Email:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('company', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Company:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('phone', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Phone:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('website', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Website:', 'salvation') . ' </span>' . 
					...
					'<div class="cmsmasters_column one_half">';
						...
						if (get_the_donator_meta('address', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Address:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('city', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('City:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('state', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('State / Province:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('zip', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Postal / Zip Code:', 'salvation') . ' </span>' . 
						...
						if (get_the_donator_meta('country', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Country:', 'salvation') . ' </span>' . 
