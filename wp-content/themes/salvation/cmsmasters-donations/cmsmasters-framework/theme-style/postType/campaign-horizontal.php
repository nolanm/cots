...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php 
	salvation_thumb($camp->ID, $cmsmasters_thumb_size, true, false, true, false, true, true, false, false, 'cmsmasters_theme_icon_money');
	
	
	if ($title) {
		salvation_donations_campaign_heading($camp->ID, 'h3', true);
	}
	...
	if ($donated_percent) {
		salvation_donations_campaign_donated($camp->ID, 'page', 'horizontal');
	}
	?>
</article>
