...
function salvation_get_admin_page() {
	global $pagenow;
...
function salvation_default_tab() {
	$current_page = salvation_get_admin_page();
...
function salvation_get_the_tab() {
	global $pagenow;
	
	$default_tab = salvation_default_tab();
...
function salvation_settings_page_header() {
