 ...
 * @version 	1.0.0
 * 
 * Content Composer Single Pricing Table Item Shortcode
...
if ($best == 'true') {
	if ($best_bg_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_price_wrap, ' . 
		'#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_button { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_bg_color) . 
			"\n\t" . cmsmasters_color_css('border-color', $best_bg_color) . 
		"\n" . '} ' . "\n" . 
		'#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_button:hover { ' . 
			"\n\t" . cmsmasters_color_css('color', $best_bg_color) . 
