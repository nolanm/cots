...
function salvation_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_breadcrumbs a:hover,
	{$rule}.cmsmasters_quotes_slider_type_center .cmsmasters_quote_subtitle_wrap .cmsmasters_quote_subtitle,
	{$rule}.cmsmasters_quotes_slider_type_center .cmsmasters_quote_subtitle + .cmsmasters_quote_site:before,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_footer a:before,
	...
	{$rule}.cmsmasters_quotes_slider_type_center  .cmsmasters_next_arrow {
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['salvation' . '_' . $scheme . '_color']) . ", 0.3);
	}
	...
	{$rule}#wp-comment-cookies-consent[type='checkbox'] + label:after, 
	...
	{$rule}.cmsmasters_mailpoet_form .wysija-submit-field,
	...
	{$rule}.datepicker table tr td span.active.active {
	...
	{$rule}.cmsmasters_project_puzzle .project_outer:hover .project_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['salvation' . '_' . $scheme . '_link']) . ", 0.9);
	}
	...
	{$rule}textarea:focus,
	{$rule}select:focus {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['salvation' . '_' . $scheme . '_link'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['salvation' . '_' . $scheme . '_link'] . ";
	}
	...
	{$rule}.cmsmasters_quotes_slider_type_center .cmsmasters_quote_site a:hover,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_header .cmsmasters_slider_post_title a:hover,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_cont_info a:hover,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_footer a:hover:before,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_read_more,
	{$rule}.cmsmasters_posts_slider .cmsmastersLike.active:before,
	{$rule}.cmsmasters_post_masonry .cmsmasters_post_header .cmsmasters_post_title a:hover,
	{$rule}.cmsmasters_project_grid .cmsmasters_project_header .cmsmasters_project_title a:hover,
	...
	{$rule}.cmsmasters_posts_slider .cmsmasters_prev_arrow:hover,
	{$rule}.cmsmasters_posts_slider .cmsmasters_next_arrow:hover,
	{$rule}.cmsmasters_mailpoet_form .wysija-submit-field:hover,
	{$rule}.cmsmasters_mailpoet_form .mailpoet_submit:hover,
	{$rule}.datepicker table tr td span.active.active:hover,
	{$rule}select option:hover {
	...
	{$rule}.cmsmasters_quotes_slider_type_center .cmsmasters_quote_site a,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_header .cmsmasters_slider_post_title a,
	{$rule}.widget a,
	{$rule}.cmsmasters_post_masonry .cmsmasters_post_header .cmsmasters_post_title a,
	{$rule}.cmsmasters_project_grid .cmsmasters_project_header .cmsmasters_project_title a,
	...
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['salvation' . '_' . $scheme . '_heading']) . ", 0.95);
	}
	...
	{$rule}.post.cmsmasters_post_puzzle .preloader:after {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['salvation' . '_' . $scheme . '_heading']) . ", 0.6);
	}
	...
	{$rule}.cmsmasters_icon_box.cmsmasters_icon_box_top:before,
	{$rule}.cmsmasters_button,
	{$rule}.cmsmasters_posts_slider .cmsmasters_prev_arrow:hover span,
	{$rule}.cmsmasters_posts_slider .cmsmasters_next_arrow:hover span,
	{$rule}.wysija-msg.ajax {
	...
	{$rule}#wp-comment-cookies-consent[type='checkbox'] + label:before, 
	...
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_project_grid .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . ", 0.98);
	}
	...
	{$rule}.cmsmasters_counters .cmsmasters_counter_wrap .cmsmasters_counter .cmsmasters_counter_inner:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['salvation' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.datepicker table tr td span:hover,
	...
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['salvation' . '_' . $scheme . '_border'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['salvation' . '_' . $scheme . '_border'] . ";
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['salvation' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['salvation' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['salvation' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('salvation_theme_colors_primary_filter', $custom_css);
}
