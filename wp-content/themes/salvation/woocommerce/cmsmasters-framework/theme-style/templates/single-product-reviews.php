			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'fields'               => array(
							'author' => '<p class="comment-form-author">' . "\n" . 
								'<input type="text" id="author" name="author" value="' . esc_attr($commenter['comment_author']) . '" size="35" aria-required="true" placeholder="' . esc_attr__('Name', 'woocommerce') . ' *" />' . "\n" . 
							'</p>' . "\n", 
							'email' => '<p class="comment-form-email">' . "\n" . 
								'<input type="text" id="email" name="email" value="' . esc_attr($commenter['comment_author_email']) . '" size="35" aria-required="true" placeholder="' . esc_attr__('Email', 'woocommerce') . ' *" />' . "\n" . 
							'</p>' . "\n",
						),
					...
					$comment_form['comment_field'] .= '<p class="comment-form-comment">' . 
							'<textarea name="comment" id="comment" cols="67" rows="2" placeholder="' . esc_attr__('Your Review', 'woocommerce') . '"></textarea>' . 
						'</p>';
