                    ...
                    <fieldset>
                        ...
                        <div class="option">
                            ...
                            <select id="shortcode-select" name="shortcode-select">
                                ...
                                <option value="shortcode-fwvideo"><?php _e('Fullscreen Video', 'imic-framework-admin'); ?></option>
                            </select>
                        </div>
                        <!--//////////////////////////////
                        ////	BUTTONS
                       ...
                       //////////////////////////////-->
                        <div id="shortcode-fwvideo" class="shortcode-option">
                            <h5><?php _e('Fullscreen Video', 'imic-framework-admin'); ?></h5>
                            <div class="option">
                        ...
                        <div id="shortcode-columns" class="shortcode-option">
                            ...
                            <div class="option">
                                ...
                                <select id="column-options" name="column-options">
                                    <option value="0"></option>
                                    <option value="one_full"><?php _e('1'); ?></option>
                                    <option value="two_halves"><?php _e('1/2 + 1/2'); ?></option>
                                    <option value="one_halves_two_quarters"><?php _e('1/2 + 1/4 + 1/4'); ?></option>
                                    <option value="three_thirds"><?php _e('1/3 + 1/3 + 1/3'); ?></option>
                                    <option value="three_two_thirds"><?php _e('1/3 + 2/3'); ?></option>
                                    <option value="two_thirds_one_thirds"><?php _e('2/3 + 1/3'); ?></option>
                                    <option value="two_quarters_one_halves"><?php _e('1/4 + 1/4 + 1/2'); ?></option>
                                    <option value="one_quarters_one_halves_one_quarters"><?php _e('1/4 + 1/2 + 1/4'); ?></option>
                                    <option value="four_quarters"><?php _e('1/4 + 1/4 + 1/4 + 1/4'); ?></option>
                                    <option value="six_one_sixths"><?php _e('1/6 + 1/6 + 1/6 + 1/6 + 1/6 + 1/6'); ?></option>
                                </select>
                            </div>
                            <div class="option">
                        ...
                        <div id="shortcode-staff">
                            ...
                            <div class="option">
                                ...
                                <select id="staff-column" name="staff-column">
                                    ...
                                    <option value="3"><?php _e('Four', 'imic-framework-admin'); ?></option>
                                    <option value="4"><?php _e('Three', 'imic-framework-admin'); ?></option>
                                    <option value="6"><?php _e('Two', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!-- SIDEBAR -->
      ...
      <div class="option">
        ...
        <select id="event-type" name="event-type">
            ...
            <option value="past"><?php _e('Past', 'imic-framework-admin'); ?></option>
                        ...
                        <div id="shortcode-tables" class="shortcode-option">
                            ...
                            <div class="option">
                                ...
                                <select id="table-rows" name="table-rows">
                                    ...
                                    <option value="10"><?php _e('10'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ...
                        <div class="option">
                                <label for="toggle-size"><?php _e('Enter Email with comma seperated', 'imic-framework-admin'); ?></label>
                        ...
                        <div id="shortcode-calendar">
                         <h5><?php _e('Calendar', 'imic-framework-admin'); ?></h5>
                        <div class="option">
                        <label for="calendar_event_category"><?php _e('Calendar Event Categories', 'imic-framework-admin'); ?></label>
