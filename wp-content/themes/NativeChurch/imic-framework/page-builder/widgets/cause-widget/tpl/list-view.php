...
<div class="posts-archive">
                    ...
                    query_posts(array('post_type'=>'causes','meta_key'=>'imic_cause_status','meta_value'=>'active','causes-category' => $the_categories,'posts_per_page' => $numberPosts));
                    if(have_posts()):
                    ...
                    <?php endwhile; endif; ?>
				<?php
                pagination(); wp_reset_query();  //Causes Pagination ?>
<?php } else { ?>
