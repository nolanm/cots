...
// Sermon video Display
    ...
    function sermon_video_display() {
      var $video_mp4 =jQuery('#imic_sermons_video_mp4_description').parents('.rwmb-file_input-wrapper');
      var $video_webm =jQuery('#imic_sermons_video_webm_description').parents('.rwmb-file_input-wrapper');
      var $video_ogv =jQuery('#imic_sermons_video_ogv_description').parents('.rwmb-file_input-wrapper');
      var $video_poster =jQuery('#imic_sermons_video_poster_description').parents('.rwmb-file_input-wrapper');
