...
$address = $_POST['admin_email'];
// Configuration option.
// i.e. The standard subject will appear as, "You've been contacted by John Doe."
// Example, $e_subject = '$name . ' has contacted you via Your Website.';
if ($subject == '') {
	$e_subject = __('Contact Form','framework');
...
$e_body = __('You have been contacted by ','framework').$name.__(' their additional message is as follows.','framework'). PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h3>".__('Email Sent Successfully.','framework')."</h3><br>";
	echo "<p>".__('Thank you ','framework')."<strong>$name</strong>, ".__('your message has been submitted to us.','framework')."</p>";
	echo "</div>";
} else {
	_e('ERROR!','framework');
}