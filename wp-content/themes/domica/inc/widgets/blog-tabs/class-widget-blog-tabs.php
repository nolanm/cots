...
class Widget_Blog_Tabs extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( false, esc_html__( 'Blog Tabs', 'domica' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$filepath = get_template_directory()."/inc/widgets/blog-tabs/views/widget.php";
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of Blog posts', 'domica' ); ?>
				:</label>
