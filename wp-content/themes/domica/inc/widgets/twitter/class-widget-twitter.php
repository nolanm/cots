...
if ( defined( 'FW' ) && function_exists( 'fw_ext_social_twitter_get_connection' ) && function_exists( 'curl_exec' ) ) {
	...
	class Widget_Twitter extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'description' => esc_html__('Twitter Feed', 'domica') );
			parent::__construct( false, esc_html__( 'Twitter', 'domica' ), $widget_ops );
		}
		...
		function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title', 'domica' ); ?> </label>
				<input type="text" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>"
				       value="<?php echo esc_attr( $instance['title'] ); ?>" class="widefat"
				       id="<?php $this->get_field_id( 'title' ); ?>"/>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php _e( 'User', 'domica' ); ?> :</label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php _e( 'Number of tweets', 'domica' ); ?>
					:</label>
