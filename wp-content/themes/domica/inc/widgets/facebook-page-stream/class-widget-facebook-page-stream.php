	...
	if ( ! empty( $fw_social_facebook ) ) {
		...
		class Widget_Facebook_Page_Stream extends WP_Widget {
			...
			function __construct() {
				...
				parent::__construct( false, esc_html__( 'Facebook', 'domica' ), $widget_ops );
			}
			...
			function form( $instance ) {
				...
				<p>
					<label
						for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title', 'domica' ); ?> </label>
					<input type="text" name="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"
					       value="<?php echo esc_attr( $instance['title'] ); ?>" class="widefat"
					       id="<?php $this->get_field_id( 'title' ); ?>"/>
				</p>
				<p>
					<label
						for="<?php echo esc_attr($this->get_field_id( 'page_id' )); ?>"><?php esc_html_e( 'Page ID:', 'domica' ); ?> </label>
				...
				<p>
					<label
						for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of posts:', 'domica' ); ?>
						:</label>
